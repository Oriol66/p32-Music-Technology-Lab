...
barra1 = ttk.Progressbar(frame1, orient='vertical', length=300, maximum=300,
...
barra7 = ttk.Progressbar(frame1, orient='vertical', length=300, maximum=300,
                         style="Vertical.TProgressbar")  # ,takefocus=True
...
volumen = ttk.Scale(frame2, to=10, from_=10, orient='horizontal', length=90, style='Horizontal.TScale')
